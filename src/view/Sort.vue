<template>
    <draggable :options="sortOption" @sort="onSort" @add="onAdd" class="app-sort">
        ...
        <div v-for="(appUi,index) in sortApi" :is="appUi.component" :content="appUi.content" :oStyle="appUi.style" :editPartShow="appUi.editPartShow" :aIndex="index" @click.native="getIndex(index)" :key="appUi.content.code">
        </div>
    </draggable>
</template>
<script>
